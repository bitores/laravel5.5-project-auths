...
@section('title', app_name() . ' | 聊天工具')

@section('after-styles')
<link href="/css/libs/workerman/jquery-sinaEmotion-2.1.0.min.css" rel="stylesheet">
<link href="/css/libs/workerman/style.css" rel="stylesheet">
@endsection
...
<div class="row clearfix">
    ...
    <div class="col-md-6 column">
       ...
       <div><b>房间列表:</b>（当前在&nbsp;房间<?php echo isset($_GET['room_id'])&&intval($_GET['room_id'])>0 ? intval($_GET['room_id']):1; ?>）<br>
       &nbsp;&nbsp;&nbsp;&nbsp;<a href="?room_id=1">房间1-大厅</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="?room_id=2">房间2-个人</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="?room_id=3">房间3-审核</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="?room_id=4">房间4-管理员</a>
       <br><br>
       </div>
    </div>
