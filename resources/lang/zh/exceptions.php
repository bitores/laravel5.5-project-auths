    ...
    */
    ...
    'backend' => [
        'access' => [
            ...
            'users' => [
                'already_confirmed'    => '用户已激活.',
                'cant_confirm'          => '激活时出了点小状况。',
                ...
                'cant_unconfirm_admin' => '你不能修改超级管理员的激活状态.',
                'cant_unconfirm_self' => '你不能修改自己的激活状态.',
                ...
                'social_delete_error' => '删除此用用户关联账号时出了点小状况。',
    ...
    'frontend' => [
        'auth' => [
            ...
            'password' => [
                ...
                'reset_problem' => '重置密码出现问题，请重新发送重置密码邮件.',
            ],
